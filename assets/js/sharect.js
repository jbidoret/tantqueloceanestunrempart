  ...
  return function(e) {
      ...
      function v(e, t, r) {
          return function(e, t) {
              ...
              var e = function(e, t) {
                  return e.replace(/PAGE_URL/, window.location.href + window.location.hash).replace(/TEXT_SELECTION/, window.getSelection().toString()).replace(/USERNAME/, t)
              }(t, r);
      ...
      t.default = (j = {
          twitter: {
              isActive: !0,
              username: "",
              url: "https://twitter.com/intent/tweet?text=TEXT_SELECTION&url=PAGE_URL",
